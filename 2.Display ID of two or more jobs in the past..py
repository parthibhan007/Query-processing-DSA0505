...
employees_with_multiple_jobs = employee_job_counts[employee_job_counts >= 2].index

result_df = df[df['EMPLOYEE_ID'].isin(employees_with_multiple_jobs)]
print("Employees who did two or more jobs in the past:")
print(result_df[['EMPLOYEE_ID', 'JOB_ID']])

#OUTPUT:-
'''Employees who did two or more jobs in the past:
   EMPLOYEE_ID      JOB_ID
1          101  AC_ACCOUNT
2          101      AC_MGR
6          200     AD_ASST
